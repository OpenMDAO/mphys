class Builder:
    ...
    def get_number_of_nodes(self):
        ...
        raise NotImplementedError(
            "Function get_number_of_nodes has not been implemented in the builder."
        )
    ...
    def get_ndof(self):
        ...
        """
        raise NotImplementedError(
            "Function get_ndof has not been implemented in the builder."
        )
    ...
    def get_tagged_indices(self, tags):
        ...
        """
        raise NotImplementedError(
            "Function get_tagged_indices has not been implemented in the builder."
        )
