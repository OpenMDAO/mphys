...
class ScenarioAeroThermal(Scenario):
    ...
    def _mphys_scenario_setup(self):
        ...
        if self.options["in_MultipointParallel"]:
            self._mphys_initialize_builders(
                aero_builder, thermal_builder, thermalxfer_builder, geometry_builder
            )
            self._mphys_add_mesh_and_geometry_subsystems(
                aero_builder, thermal_builder, geometry_builder
            )
        ...
        self._mphys_add_pre_coupling_subsystem_from_builder(
            "thermalxfer", thermalxfer_builder, self.name
        )
    ...
    def _mphys_initialize_builders(
        self, aero_builder, thermal_builder, thermalxfer_builder, geometry_builder
    ):
    ...
    def _mphys_add_mesh_and_geometry_subsystems(
        self, aero_builder, thermal_builder, geometry_builder
    ):
...
class CouplingAeroThermal(CouplingGroup):
    ...
    def setup(self):
        ...
        heat_xfer, temp_xfer = thermalxfer_builder.get_coupling_group_subsystem(
            scenario_name
        )
