...
model.add_design_var(
    "geometry.Tank:Design:A_Radius", lower=1e-3, upper=10.0, scaler=20.0
)
model.add_design_var(
    "geometry.Tank:Design:B_Radius", lower=1e-3, upper=10.0, scaler=20.0
)
model.add_design_var(
    "geometry.Tank:Design:C_Radius", lower=1e-3, upper=10.0, scaler=20.0
)
