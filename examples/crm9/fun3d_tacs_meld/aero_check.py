...
model.connect('ivc.alpha',['sfe.alpha','integrated_forces.alpha'])
...
model.connect('ivc.x_a',['integrated_forces.x_a'])
...
#prob.check_totals(of=['integrated_forces.F_Z'], wrt=['ivc.mach','ivc.alpha'])
#print('TOTALS',prob.compute_totals(of=['integrated_forces.F_Z'], wrt=['ivc.q_inf','ivc.alpha','ivc.mach']))
