...
if __name__ == "__main__":
    ...
    func_struct1 = prob.get_val('multipoint.aerostructural1.func_struct', get_remote=True)
    ...
    func_struct2 = prob.get_val('multipoint.aerostructural2.func_struct', get_remote=True)
    ...
    prob.check_totals(
        of=['multipoint.aerostructural1.mass',
