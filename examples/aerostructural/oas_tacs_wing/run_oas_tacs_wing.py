...
class Top(Multipoint):
    def setup(self):
        ...
        dvs.add_output(
            MPhysVariables.Aerodynamics.FlowConditions.YAW_ANGLE, val=yaw, units="deg"
        )
        ...
        dvs.add_output(
            MPhysVariables.Aerodynamics.FlowConditions.REYNOLDS_NUMBER, re, units="1/m"
        )
...
model.add_constraint(
    "maneuver.adjacency.LE_SPAR", lower=-2.5e-3, upper=2.5e-3, scaler=1e3, linear=True
)
model.add_constraint(
    "maneuver.adjacency.TE_SPAR", lower=-2.5e-3, upper=2.5e-3, scaler=1e3, linear=True
)
model.add_constraint(
    "maneuver.adjacency.UPPER_SKIN",
    lower=-2.5e-3,
    upper=2.5e-3,
    scaler=1e3,
    linear=True,
