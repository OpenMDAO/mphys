...
class WingGeometry(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('x_struct0_mesh',shape=len(self.options['xs']))
        self.add_output('x_aero0_mesh',shape=len(self.options['xa']))

        self.declare_partials('x_struct0_mesh','root_chord_delta')
        self.declare_partials('x_struct0_mesh','tip_chord_delta')
        self.declare_partials('x_struct0_mesh','tip_sweep_delta')
        self.declare_partials('x_struct0_mesh','span_delta')
        self.declare_partials('x_struct0_mesh','wing_thickness_delta')
        self.declare_partials('x_struct0_mesh','wing_twist_delta')
        self.declare_partials('x_aero0_mesh','root_chord_delta')
        self.declare_partials('x_aero0_mesh','tip_chord_delta')
        self.declare_partials('x_aero0_mesh','tip_sweep_delta')
        self.declare_partials('x_aero0_mesh','span_delta')
        self.declare_partials('x_aero0_mesh','wing_thickness_delta')
        self.declare_partials('x_aero0_mesh','wing_twist_delta')
    ...
    def compute(self,inputs,outputs):
        ...
        outputs['x_struct0_mesh'] = self.xs_new
        outputs['x_aero0_mesh'] = self.xa_new

    def compute_partials(self,inputs,partials):

        self.compute_derivatives()

        partials['x_struct0_mesh','root_chord_delta'] = self.xs_root_chord_DV
        partials['x_struct0_mesh','tip_chord_delta'] = self.xs_tip_chord_DV
        partials['x_struct0_mesh','tip_sweep_delta'] = self.xs_tip_sweep_DV
        partials['x_struct0_mesh','span_delta'] = self.xs_span_DV
        partials['x_struct0_mesh','wing_thickness_delta'] = self.xs_thickness_DV
        partials['x_struct0_mesh','wing_twist_delta'] = self.xs_twist_DV

        partials['x_aero0_mesh','root_chord_delta'] = self.xa_root_chord_DV
        partials['x_aero0_mesh','tip_chord_delta'] = self.xa_tip_chord_DV
        partials['x_aero0_mesh','tip_sweep_delta'] = self.xa_tip_sweep_DV
        partials['x_aero0_mesh','span_delta'] = self.xa_span_DV
        partials['x_aero0_mesh','wing_thickness_delta'] = self.xa_thickness_DV
        partials['x_aero0_mesh','wing_twist_delta'] = self.xa_twist_DV
