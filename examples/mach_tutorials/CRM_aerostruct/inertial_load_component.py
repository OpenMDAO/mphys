            ...
            for i in range(0,len(quad)):
                ...
                if 'F_inertial' in d_outputs:
                    if 'x_struct0' in d_inputs:
                        ...
                        d_inputs['x_struct0'][quad[i,:]*3+0] += np.tile(A_X,(4,1)).transpose()@d_outputs['F_inertial'][quad[i,:]*6+2]*gravity*rho*t/4
                        d_inputs['x_struct0'][quad[i,:]*3+1] += np.tile(A_Y,(4,1)).transpose()@d_outputs['F_inertial'][quad[i,:]*6+2]*gravity*rho*t/4
                        d_inputs['x_struct0'][quad[i,:]*3+2] += np.tile(A_Z,(4,1)).transpose()@d_outputs['F_inertial'][quad[i,:]*6+2]*gravity*rho*t/4
