...
if use_modal:
    ...
    struct_assembler = TacsOmfsiAssembler(tacs_setup,check_partials=True)
...
xfer_assembler = MeldAssembler(meld_options,struct_assembler,aero_assembler,check_partials=True)
...
fsi_group.nonlinear_solver = NonlinearBlockGS(maxiter=100, iprint=2, use_aitken=True, atol=1E-9)
