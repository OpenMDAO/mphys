...
1. Call :func:`~mphys.core.scenario.Scenario.mphys_add_pre_coupling_subsystem` for each builder.
2. Instantiate the associated :class:`~mphys.coupling_group.CouplingGroup`.
3. Call :func:`~mphys.core.scenario.Scenario.mphys_add_post_coupling_subsystem` for each builder.


.. automodule:: mphys.core.scenario
